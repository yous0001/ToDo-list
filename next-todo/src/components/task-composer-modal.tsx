...
export const TaskComposerModal = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/70 px-4 py-10 backdrop-blur-sm"
      ...
      >
        ...
        <div className="mb-6 space-y-2 pr-10">
          ...
          <p className="text-sm text-slate-500">
            Add a clear title and optional notes. Timers start directly from the
            task card once saved.
          </p>
        </div>
